...
global {
	...
	int K_people <- 100; // Number of active TB people who interrupt their treatment;
...
experiment Simulation_Math_TB type: gui {
	...
	parameter 'Mortality not linked to TB: mu2' type: float var: mu2 <- 0.0 category: "Parameters"; //rate of mortality not related to TB infection
	parameter 'Rate of transfer: beta (I->K)' type: float var:beta <- 0.0 category: "Parameters"; //rate of transferred people in a other hospital
	parameter 'Rate of recovered after treatment: gamma (I->R1)' type: float var:gamma <- 0.0 category: "Parameters"; //rate of recovered after treatment process
	parameter 'Rate of spontaneously recovered: sigma (I->R2)' type: float var: sigma<-0.0 category: "Parameters"; //rate of spontaneously recovered
	parameter 'Rate of contact' type: float var:alpha <-0.0  category: "Parameters"; //rate of contact
	parameter 'Rate of transmission: lambda' type: float var: lambda <- 0.0  category: "Parameters"; // rate of transmission
	parameter 'Proportion of people: p (S-> Le & I)' type: float var: p <-0.0  category: "Parameters"; // proportion of people
	parameter 'Rate of progression to ATB: q (Le->I)' type: float var: q <-0.0  category: "Parameters"; // Rate of progression to ATB: q (Le->I)
	parameter 'Rate of progression to ATB: w (Lf->I)' type: float var: w <-0.0  category: "Parameters"; // Rate of progression to ATB: w (Lf->I)
	...
	parameter'Rate of re-infection: r1 (I->Le)' type: float var: r1 <- 0.0  category: "Parameters"; //rate of re-infection from I to Le
	parameter'Rate of re-infection: r2 (I->Le)' type: float var: r2 <- 0.0  category: "Parameters"; //rate of re-infection from T to Le
	parameter'Rate of re-infection: r3 (I->Le)' type: float var: r3 <- 0.0  category: "Parameters"; //rate of re-infection from K to Le
	parameter 'Recovered after treatment: g1 (Le->R1)' type: float var: g1 <- 0.0  category: "Parameters"; //rate of recovered after treatment process from Le to R1
	...
	parameter 'Recovered after treatment: k1 (Lf->R1)' type: float var: k1 <- 0.0  category: "Parameters"; //rate of recovered after treatment process from Lf to R1
	parameter 'Recovered spontaneously: k2(Lf->R2)' type: float var: k2 <- 0.0  category: "Parameters"; // rate of spontaneously recovered from Lf to R2
	parameter 'Rate of reactivation: r (R1 & R2 -> Le)' type: float var: r <- 0.0  category: "Parameters"; // Rate of reactivation: r (R1 & R2 -> Le)
